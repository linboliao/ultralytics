...
class MultiMagConv(Conv):
    def __init__(self, c1, c2, k=1, s=1):
        ...
        self.layer_1_fusion = nn.Sequential(Fusion(c2 // 2 * 3, c2 // 2), PConv(c2 // 2, c2, 1, s))
    ...
    def forward(self, x):
        ...
        layer_1_high = self.layer_1_conv_high(x[:, 0:3, :, :])
        ...
        layer_2_high = self.layer_2_conv_high(layer_1_high)
