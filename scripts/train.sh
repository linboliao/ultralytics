...
ckpt=runs/segment/yolo12-sfam/weights/last.pt
...
name=yolo12-sfam
project=runs
python tasks/train.py --model $model --ckpt $ckpt --data $data --epoches $epoches --image_size $image_size --gpu_ids $gpu_ids --batch $batch --lr0 $lr --name $name --resume #--project $project --resume
