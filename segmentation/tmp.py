...
slides = os.listdir('/NAS2/Data1/lbliao/Data/MXB/cellvit/slides')
slides = [slide.replace('.svs', '') for slide in slides]
for slide in slides:
    cells_path = f'/NAS2/Data1/lbliao/Data/MXB/cellvit/patch/{slide}/cell_detection/cells.geojson'
    if os.path.exists(cells_path):
        new_path = f'/NAS2/Data1/lbliao/Data/MXB/cellvit/results/{slide}.geojson'
