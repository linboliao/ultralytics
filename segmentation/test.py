...
# parser.add_argument('--ckpt', type=list, default=['/data2/lbliao/Code/ultralytics/runs/detect/Pconv/weights/best.pt', '/data2/lbliao/Code/ultralytics/runs/detect/cellvit+/weights/best.pt', '/NAS2/Data1/lbliao/Code/ultralytics/runs/detect/0512/weights/best.pt'])
...
parser.add_argument('--slide', type=str)#, default='202453379.60.kfb', help='patch directory')
