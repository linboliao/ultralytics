...
parser.add_argument('--data_root', type=str, default='/NAS2/Data1/lbliao/Data/MXB/test', help='patch directory')
...
parser.add_argument('--output_dir', type=str, default='/NAS2/Data1/lbliao/Data/MXB/test/result', help='output directory')
parser.add_argument('--patch_size', type=int, default=2048, help='patch size')
parser.add_argument('--infer_size', type=int, default=2048, help='patch size')
