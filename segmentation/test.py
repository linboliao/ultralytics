...
parser.add_argument('--output_dir', type=str, default='/NAS2/Data1/lbliao/Data/MXB/seminal/result', help='output directory')
...
parser.add_argument('--slide_list', type=list, default=['1547583.4无癌.kfb', '1547583.8无癌.kfb', '1604701.5无癌.kfb', '1604701.8无癌.kfb'])
